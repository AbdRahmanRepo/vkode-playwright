...
tag with id         tag#id    or      #id. -> input#small-searchterms
tag with class      tag.class   or    .class    -> input.search-box-text
tag with any other attribute  tag[attribute=value]  or    [attribute=value] -> input[name='q']
tag with class and attribute  tag.class[attribute=value]  or  .class[attribute=value] -> input.search-box-text[name='q']
